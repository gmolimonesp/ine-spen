...
// --- FUNCIÓN PARA EL BUSCADOR FLOTANTE ---
function toggleSearch() {
    var searchBox = document.getElementById("searchBox");
    var searchInput = document.getElementById("searchInput");
    
    // Alterna la clase 'visible' para mostrar/ocultar con CSS
    searchBox.classList.toggle("visible");

    // Lógica de enfoque y limpieza
    if (searchBox.classList.contains("visible")) {
        searchInput.focus();
    } else {
        searchInput.value = "";
        // Ejecutamos la búsqueda vacía para resetear la tabla
        searchInActiveTab(); 
    }
}