        ...
        <?php else: ?>
            ...
            <?php for($b=1; $b<=7; $b++): ?>
                <div id="libro<?php echo $b; ?>" class="book-content <?php echo $b===1?'active':''; ?>">
                    ...
                    $stmt = $pdo->prepare("SELECT * FROM articulos WHERE ley_id = ? AND libro_numero = ? ORDER BY ley_id ASC, libro_numero ASC, CAST(REGEXP_SUBSTR(articulo_numero, '[0-9]+') AS UNSIGNED) ASC, articulo_numero ASC, cabecera_descanso ASC;");
